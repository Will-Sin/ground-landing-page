...
var bookVerifyBox = document.getElementsByClassName("book-verify-box");
...
function interactionCalculator(response_object) {
  ...
  if (interactionsCount <= 0) {
    ...
    interactionsCountDiv.innerHTML = `<i>You now can ask <b>${interactionsCount}</b> questions to the Oracle. After those are up, you'll need a new offering.</i>`
...
async function fetchChat(user_input, chat_history) {
  ...
  return fetch(`${productionURL}/book/${bookID}/GREEN/1/`, requestOptions)
};
